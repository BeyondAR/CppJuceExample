...
//==============================================================================
public final class juceexamplelib   extends Activity
{
    //==============================================================================
    static
    {
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            juceexamplelib.this.alertDismissed (callback, 0);
                        }
                    });
               ...
               .setPositiveButton ("OK", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            juceexamplelib.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.cancel();
                            juceexamplelib.this.alertDismissed (callback, 2);
                        }
                    })
